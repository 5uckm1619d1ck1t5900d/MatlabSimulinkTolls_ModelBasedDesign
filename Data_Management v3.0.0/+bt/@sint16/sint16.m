...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Signed integer 16bits datatype class definition

% Change Log:
% 16mar2015 PLefler     Added checking for zero arguments being passed to class constructor method.

classdef sint16 < Simulink.AliasType
    properties (Constant = true)
        Signed = true;
        InterfacePath = '/PortInterfaces/CalPortInterface_sint16';
        dtMin  = -32768;     %Minimum allowed (Cnt)
        dtMax  = 32767;      %Maximum allowed (Cnt)
    end
    properties
        dtScl;       %FloatToFixed
    end
    ...
    methods
        ...
        function [engmin,scaledmin,str] = validateUserEngMin(obj,val)
            ...
            engmin = val;
            scaledmin = double(single(round(val*obj.dtScl)));
        end
        ...
        function [engmax,scaledmax,str] = validateUserEngMax(obj,val)
            ...
            engmax = val;
            scaledmax = double(single(round(val*obj.dtScl)));
        end
