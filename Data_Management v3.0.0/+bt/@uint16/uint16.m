...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Unsigned integer 16bits datatype cclass definition

% Change Log:
% 16mar2015 PLefler     Added checking for zero arguments being passed to class constructor method.

classdef uint16 < Simulink.AliasType
    properties (Constant = true)
        Signed = false;
        InterfacePath = '/PortInterfaces/CalPortInterface_uint16';
        dtMin  = 0;     %Minimum allowed (Cnt)
        dtMax  = 65535;      %Maximum allowed (Cnt)
    end
    properties
        dtScl;       %FloatToFixed
    end
