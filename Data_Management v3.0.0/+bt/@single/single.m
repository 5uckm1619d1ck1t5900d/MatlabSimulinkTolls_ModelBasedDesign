...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Single datatype class definition

classdef single < Simulink.AliasType
    properties (Constant = true)
        Signed = true;
        InterfacePath = '/PortInterfaces/CalPortInterface_single';
        dtMin  = double(single(-3.402823466E+38));     %Minimum allowed (Cnt)
        dtMax  = double(single( 3.402823466E+38));;      %Maximum allowed (Cnt)
    end
    properties
        dtScl;       %FloatToFixed
    end
