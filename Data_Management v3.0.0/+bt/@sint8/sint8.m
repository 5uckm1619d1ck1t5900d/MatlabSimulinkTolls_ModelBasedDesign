...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Signed integer 8bits datatype class definition

% Change Log:
% 16mar2015 PLefler     Added checking for zero arguments being passed to class constructor method. 

classdef sint8 < Simulink.AliasType
    properties (Constant = true)
        Signed = true;
        InterfacePath = '/PortInterfaces/CalPortInterface_sint8';
        dtMin  = -128;     %Minimum allowed (Cnt)
        dtMax  =  127;      %Maximum allowed (Cnt)
    end
    properties
        dtScl;       %FloatToFixed
    end
