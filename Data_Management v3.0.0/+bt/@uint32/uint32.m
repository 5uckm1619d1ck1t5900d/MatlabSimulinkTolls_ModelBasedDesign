...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Unsigned integer 32bits datatype class definition
...
classdef uint32 < Simulink.AliasType
    properties (Constant = true)
        Signed = false;
        InterfacePath = '/PortInterfaces/CalPortInterface_uint32';
        dtMin  = 0;     %Minimum allowed (Cnt)
        dtMax  = 4294967295;      %Maximum allowed (Cnt)
    end
