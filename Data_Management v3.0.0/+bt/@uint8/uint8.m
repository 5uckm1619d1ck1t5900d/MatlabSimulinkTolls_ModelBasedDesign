...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Unsigned integer 8bits  datatype class definition

% Change Log:
% 16mar2015 PLefler     Added checking for zero arguments being passed to class constructor method.

classdef uint8 < Simulink.AliasType
    properties (Constant = true)
        InterfacePath = '/PortInterfaces/CalPortInterface_uint8';
        Signed = false;
        dtMin  = 0;     %Minimum allowed (Cnt)
        dtMax  = 255;      %Maximum allowed (Cnt)
    end
    properties
        dtScl;       %FloatToFixed
    end
