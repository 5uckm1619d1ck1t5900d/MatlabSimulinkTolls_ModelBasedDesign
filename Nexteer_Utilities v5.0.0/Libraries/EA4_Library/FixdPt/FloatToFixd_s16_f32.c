/*
 *   FloatToFixd_s16_f32.c Simple C-MEX S-function for function call.
 *
 *   ABSTRACT:
 *     The purpose of this sfunction is to call a simple legacy
 *     function during simulation:
 *
 *         int16 y1 = FloatToFixd_s16_f32(single u1, single u2)
 *
 *   Simulink version           : 8.2 (R2013b) 08-Aug-2013
 *   C source code generated on : 10-Mar-2015 14:42:45
...
/*
   ...
   def.SFunctionName = 'FloatToFixd_s16_f32';
   def.OutputFcnSpec = ' int16 y1 = FloatToFixd_s16_f32(single u1, single u2)';
 ...
 */
#define S_FUNCTION_NAME                FloatToFixd_s16_f32
...
static void mdlInitializeSizes(SimStruct *S)
{
  ...
  if (ssRTWGenIsCodeGen(S) || ssGetSimMode(S)==SS_SIMMODE_EXTERNAL) {
     ...
     */
    ssRegMdlInfo(S, "FloatToFixd_s16_f32", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath
                 (S));
  }
