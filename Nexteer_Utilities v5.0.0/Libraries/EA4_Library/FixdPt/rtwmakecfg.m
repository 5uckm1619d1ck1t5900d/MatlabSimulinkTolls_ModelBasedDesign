...
%   MATLAB file generated on : 10-Mar-2015 14:42:59
...
% Dependency info for S-function 'FloatToFixdWithRound_s16_f32'
info(1).SFunctionName = 'FloatToFixdWithRound_s16_f32';
info(1).IncPaths = {'..\SrcFiles'};
info(1).Language = 'C';
% Dependency info for S-function 'FloatToFixdWithRound_s32_f32'
info(2).SFunctionName = 'FloatToFixdWithRound_s32_f32';
info(2).IncPaths = {'..\SrcFiles'};
info(2).Language = 'C';
% Dependency info for S-function 'FloatToFixdWithRound_u16_f32'
info(3).SFunctionName = 'FloatToFixdWithRound_u16_f32';
info(3).IncPaths = {'..\SrcFiles'};
info(3).Language = 'C';
% Dependency info for S-function 'FloatToFixdWithRound_u32_f32'
info(4).SFunctionName = 'FloatToFixdWithRound_u32_f32';
info(4).IncPaths = {'..\SrcFiles'};
info(4).Language = 'C';
% Dependency info for S-function 'FloatToFixd_s16_f32'
info(5).SFunctionName = 'FloatToFixd_s16_f32';
info(5).IncPaths = {'..\SrcFiles'};
info(5).Language = 'C';
% Dependency info for S-function 'FloatToFixd_s32_f32'
info(6).SFunctionName = 'FloatToFixd_s32_f32';
info(6).IncPaths = {'..\SrcFiles'};
info(6).Language = 'C';
% Dependency info for S-function 'FloatToFixd_u16_f32'
info(7).SFunctionName = 'FloatToFixd_u16_f32';
info(7).IncPaths = {'..\SrcFiles'};
info(7).Language = 'C';
% Dependency info for S-function 'FloatToFixd_u32_f32'
info(8).SFunctionName = 'FloatToFixd_u32_f32';
info(8).IncPaths = {'..\SrcFiles'};
info(8).Language = 'C';
% Dependency info for S-function 'FixdToFloat_f32_s16'
info(9).SFunctionName = 'FixdToFloat_f32_s16';
info(9).IncPaths = {'..\SrcFiles'};
info(9).Language = 'C';
% Dependency info for S-function 'FixdToFloat_f32_s32'
info(10).SFunctionName = 'FixdToFloat_f32_s32';
info(10).IncPaths = {'..\SrcFiles'};
info(10).Language = 'C';
% Dependency info for S-function 'FixdToFloat_f32_u16'
info(11).SFunctionName = 'FixdToFloat_f32_u16';
info(11).IncPaths = {'..\SrcFiles'};
info(11).Language = 'C';
% Dependency info for S-function 'FixdToFloat_f32_u32'
info(12).SFunctionName = 'FixdToFloat_f32_u32';
info(12).IncPaths = {'..\SrcFiles'};
info(12).Language = 'C';
