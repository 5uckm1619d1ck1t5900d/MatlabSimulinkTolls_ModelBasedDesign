/*
 *   FixdToFloat_f32_u16.c Simple C-MEX S-function for function call.
 *
 *   ABSTRACT:
 *     The purpose of this sfunction is to call a simple legacy
 *     function during simulation:
 *
 *        single y1 = FixdToFloat_f32_u16(uint16 u1, single u2)
 *
 *   Simulink version           : 8.2 (R2013b) 08-Aug-2013
 *   C source code generated on : 10-Mar-2015 14:42:55
...
/*
   ...
   def.SFunctionName = 'FixdToFloat_f32_u16';
   def.OutputFcnSpec = 'single y1 = FixdToFloat_f32_u16(uint16 u1, single u2)';
 ...
 */
#define S_FUNCTION_NAME                FixdToFloat_f32_u16
...
static void mdlInitializeSizes(SimStruct *S)
{
  ...
  if (ssRTWGenIsCodeGen(S) || ssGetSimMode(S)==SS_SIMMODE_EXTERNAL) {
     ...
     */
    ssRegMdlInfo(S, "FixdToFloat_f32_u16", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath
                 (S));
  }
