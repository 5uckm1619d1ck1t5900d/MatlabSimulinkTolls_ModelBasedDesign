/*
 *   Min_u08.c Simple C-MEX S-function for function call.
 *
 *   ABSTRACT:
 *     The purpose of this sfunction is to call a simple legacy
 *     function during simulation:
 *
 *         uint8 y1 = Min_u08( uint8 u1,  uint8 u2)
 *
 *   Simulink version           : 8.2 (R2013b) 08-Aug-2013
 *   C source code generated on : 06-Mar-2015 09:20:59
...
/*
   ...
   def.SFunctionName = 'Min_u08';
   def.OutputFcnSpec = ' uint8 y1 = Min_u08( uint8 u1,  uint8 u2)';
 ...
 */
#define S_FUNCTION_NAME                Min_u08
...
static void mdlInitializeSizes(SimStruct *S)
{
  ...
  if (ssRTWGenIsCodeGen(S) || ssGetSimMode(S)==SS_SIMMODE_EXTERNAL) {
     ...
     */
    ssRegMdlInfo(S, "Min_u08", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));
  }
