...
%   MATLAB file generated on : 30-Mar-2015 11:51:34
...
% Dependency info for S-function 'TblSize_u16_s16'
info(1).SFunctionName = 'TblSize_u16_s16';
info(1).IncPaths = {'..\SrcFiles'};
info(1).Language = 'C';
% Dependency info for S-function 'TblSize_u16_u16'
info(2).SFunctionName = 'TblSize_u16_u16';
