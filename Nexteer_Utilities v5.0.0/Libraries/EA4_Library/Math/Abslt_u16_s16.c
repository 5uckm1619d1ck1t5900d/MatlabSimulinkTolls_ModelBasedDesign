/*
 *   Abslt_u16_s16.c Simple C-MEX S-function for function call.
 *
 *   ABSTRACT:
 *     The purpose of this sfunction is to call a simple legacy
 *     function during simulation:
 *
 *        uint16 y1 = Abslt_u16_s16( int16 u1)
 *
 *   Simulink version           : 8.2 (R2013b) 08-Aug-2013
 *   C source code generated on : 06-Mar-2015 09:20:45
...
/*
   ...
   def.SFunctionName = 'Abslt_u16_s16';
   def.OutputFcnSpec = 'uint16 y1 = Abslt_u16_s16( int16 u1)';
 ...
 */
#define S_FUNCTION_NAME                Abslt_u16_s16
...
static void mdlInitializeSizes(SimStruct *S)
{
  ...
  if (ssRTWGenIsCodeGen(S) || ssGetSimMode(S)==SS_SIMMODE_EXTERNAL) {
     ...
     */
    ssRegMdlInfo(S, "Abslt_u16_s16", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));
  }
