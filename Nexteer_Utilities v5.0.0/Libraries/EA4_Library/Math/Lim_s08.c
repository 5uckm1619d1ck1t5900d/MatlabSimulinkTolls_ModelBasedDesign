/*
 *   Lim_s08.c Simple C-MEX S-function for function call.
 *
 *   ABSTRACT:
 *     The purpose of this sfunction is to call a simple legacy
 *     function during simulation:
 *
 *          int8 y1 = Lim_s08(  int8 u1,   int8 u2,   int8 u3)
 *
 *   Simulink version           : 8.2 (R2013b) 08-Aug-2013
 *   C source code generated on : 06-Mar-2015 09:21:22
...
/*
   ...
   def.SFunctionName = 'Lim_s08';
   def.OutputFcnSpec = '  int8 y1 = Lim_s08(  int8 u1,   int8 u2,   int8 u3)';
 ...
 */
#define S_FUNCTION_NAME                Lim_s08
...
static void mdlInitializeSizes(SimStruct *S)
{
  ...
  if (ssRTWGenIsCodeGen(S) || ssGetSimMode(S)==SS_SIMMODE_EXTERNAL) {
     ...
     */
    ssRegMdlInfo(S, "Lim_s08", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));
  }
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
  ...
  int8_T *u3 = (int8_T *) ssGetInputPortSignal(S, 2);
