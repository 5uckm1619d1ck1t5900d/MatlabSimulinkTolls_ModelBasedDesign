/*
 *   Blnd_f32.c Simple C-MEX S-function for function call.
 *
 *   ABSTRACT:
 *     The purpose of this sfunction is to call a simple legacy
 *     function during simulation:
 *
 *        single y1 = Blnd_f32(single u1, single u2, single u3)
 *
 *   Simulink version           : 8.2 (R2013b) 08-Aug-2013
 *   C source code generated on : 06-Mar-2015 09:20:42
 ...
 */
#define S_FUNCTION_NAME                Blnd_f32
...
static void mdlInitializeSizes(SimStruct *S)
{
  ...
  if (ssRTWGenIsCodeGen(S) || ssGetSimMode(S)==SS_SIMMODE_EXTERNAL) {
     ...
     */
    ssRegMdlInfo(S, "Blnd_f32", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));
  }
