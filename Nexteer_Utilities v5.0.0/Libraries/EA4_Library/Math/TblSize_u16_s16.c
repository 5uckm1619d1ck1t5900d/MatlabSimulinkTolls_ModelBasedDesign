/*
 *   TblSize_u16_s16.c Simple C-MEX S-function for function call.
 *
 *   ABSTRACT:
 *     The purpose of this sfunction is to call a simple legacy
 *     function during simulation:
 *
 *        uint16 y1 = TblSize_m( int16 u1[])
 *
 *   Simulink version           : 8.2 (R2013b) 08-Aug-2013
 *   C source code generated on : 30-Mar-2015 11:51:29
...
/*
   ...
   def.SFunctionName = 'TblSize_u16_s16';
   def.OutputFcnSpec = 'uint16 y1 = TblSize_m( int16 u1[])';
 ...
 */
#define S_FUNCTION_NAME                TblSize_u16_s16
