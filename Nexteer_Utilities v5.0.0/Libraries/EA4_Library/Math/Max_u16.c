/*
 *   Max_u16.c Simple C-MEX S-function for function call.
 *
 *   ABSTRACT:
 *     The purpose of this sfunction is to call a simple legacy
 *     function during simulation:
 *
 *        uint16 y1 = Max_u16(uint16 u1, uint16 u2)
 *
 *   Simulink version           : 8.2 (R2013b) 08-Aug-2013
 *   C source code generated on : 06-Mar-2015 09:21:15
...
/*
   ...
   def.SFunctionName = 'Max_u16';
   def.OutputFcnSpec = 'uint16 y1 = Max_u16(uint16 u1, uint16 u2)';
 ...
 */
#define S_FUNCTION_NAME                Max_u16
...
static void mdlInitializeSizes(SimStruct *S)
{
  ...
  if (ssRTWGenIsCodeGen(S) || ssGetSimMode(S)==SS_SIMMODE_EXTERNAL) {
     ...
     */
    ssRegMdlInfo(S, "Max_u16", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));
  }
