/*
 *   Max_s32.c Simple C-MEX S-function for function call.
 *
 *   ABSTRACT:
 *     The purpose of this sfunction is to call a simple legacy
 *     function during simulation:
 *
 *         int32 y1 = Max_s32( int32 u1,  int32 u2)
 *
 *   Simulink version           : 8.2 (R2013b) 08-Aug-2013
 *   C source code generated on : 06-Mar-2015 09:21:16
...
/*
   ...
   def.SFunctionName = 'Max_s32';
   def.OutputFcnSpec = ' int32 y1 = Max_s32( int32 u1,  int32 u2)';
 ...
 */
#define S_FUNCTION_NAME                Max_s32
...
static void mdlInitializeSizes(SimStruct *S)
{
  ...
  if (ssRTWGenIsCodeGen(S) || ssGetSimMode(S)==SS_SIMMODE_EXTERNAL) {
     ...
     */
    ssRegMdlInfo(S, "Max_s32", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));
  }
