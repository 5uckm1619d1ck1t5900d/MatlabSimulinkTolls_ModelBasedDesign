/*
 *   Min_u32.c Simple C-MEX S-function for function call.
 *
 *   ABSTRACT:
 *     The purpose of this sfunction is to call a simple legacy
 *     function during simulation:
 *
 *        uint32 y1 = Min_u32(uint32 u1, uint32 u2)
 *
 *   Simulink version           : 8.2 (R2013b) 08-Aug-2013
 *   C source code generated on : 06-Mar-2015 09:21:06
...
/*
   ...
   def.SFunctionName = 'Min_u32';
   def.OutputFcnSpec = 'uint32 y1 = Min_u32(uint32 u1, uint32 u2)';
 ...
 */
#define S_FUNCTION_NAME                Min_u32
...
static void mdlInitializeSizes(SimStruct *S)
{
  ...
  if (ssRTWGenIsCodeGen(S) || ssGetSimMode(S)==SS_SIMMODE_EXTERNAL) {
     ...
     */
    ssRegMdlInfo(S, "Min_u32", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));
  }
