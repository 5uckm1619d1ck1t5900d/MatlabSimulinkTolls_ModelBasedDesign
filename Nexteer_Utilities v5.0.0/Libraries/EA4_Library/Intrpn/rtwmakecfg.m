...
%   MATLAB file generated on : 30-Mar-2015 11:41:00
...
% Dependency info for S-function 'BilnrIntrpnWithRound_u16_u16CmnXu16MplY'
info(1).SFunctionName = 'BilnrIntrpnWithRound_u16_u16CmnXu16MplY';
info(1).IncPaths = {'..\SrcFiles'};
info(1).SrcPaths = {'..\SrcFiles'};
info(1).SourceFiles = {'NxtrIntrpn.c'};
info(1).Language = 'C';
% Dependency info for S-function 'BilnrIntrpnWithRound_s16_u16CmnXs16MplY'
info(2).SFunctionName = 'BilnrIntrpnWithRound_s16_u16CmnXs16MplY';
info(2).IncPaths = {'..\SrcFiles'};
info(2).SrcPaths = {'..\SrcFiles'};
info(2).SourceFiles = {'NxtrIntrpn.c'};
info(2).Language = 'C';
% Dependency info for S-function 'BilnrIntrpnWithRound_s16_s16CmnXs16MplY'
info(3).SFunctionName = 'BilnrIntrpnWithRound_s16_s16CmnXs16MplY';
info(3).IncPaths = {'..\SrcFiles'};
info(3).SrcPaths = {'..\SrcFiles'};
info(3).SourceFiles = {'NxtrIntrpn.c'};
info(3).Language = 'C';
% Dependency info for S-function 'BilnrIntrpnWithRound_u16_s16CmnXu16MplY'
info(4).SFunctionName = 'BilnrIntrpnWithRound_u16_s16CmnXu16MplY';
info(4).IncPaths = {'..\SrcFiles'};
info(4).SrcPaths = {'..\SrcFiles'};
info(4).SourceFiles = {'NxtrIntrpn.c'};
info(4).Language = 'C';
