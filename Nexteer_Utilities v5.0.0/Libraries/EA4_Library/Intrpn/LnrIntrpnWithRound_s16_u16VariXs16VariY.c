/*
 *   LnrIntrpnWithRound_s16_u16VariXs16VariY.c Simple C-MEX S-function for function call.
 *
 *   ABSTRACT:
 *     The purpose of this sfunction is to call a simple legacy
 *     function during simulation:
 *
 *         int16 y1 = LnrIntrpnWithRound_s16_u16VariXs16VariY(uint16 u1[],  int16 u2[], uint16 u3, uint16 u4)
 *
 *   Simulink version           : 8.2 (R2013b) 08-Aug-2013
 *   C source code generated on : 27-Mar-2015 15:12:37
 ...
 */
#define S_FUNCTION_NAME                LnrIntrpnWithRound_s16_u16VariXs16VariY
...
static void mdlInitializeSizes(SimStruct *S)
{
  ...
  if (ssRTWGenIsCodeGen(S) || ssGetSimMode(S)==SS_SIMMODE_EXTERNAL) {
     ...
     */
    ssRegMdlInfo(S, "LnrIntrpnWithRound_s16_u16VariXs16VariY",
 ...
 */
*y1 = LnrIntrpnWithRound_s16_u16VariXs16VariY( u1, u2, *u3, *u4);
}
