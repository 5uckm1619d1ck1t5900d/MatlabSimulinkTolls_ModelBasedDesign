/*
 *   LnrIntrpn_s16_u16FixdXs16VariY.c Simple C-MEX S-function for function call.
 *
 *   ABSTRACT:
 *     The purpose of this sfunction is to call a simple legacy
 *     function during simulation:
 *
 *         int16 y1 = LnrIntrpn_s16_u16FixdXs16VariY(uint16 u1,  int16 u2[], uint16 u3, uint16 u4)
 *
 *   Simulink version           : 8.2 (R2013b) 08-Aug-2013
 *   C source code generated on : 09-Jul-2015 08:17:06
...
/*
   ...
   def.SFunctionName = 'LnrIntrpn_s16_u16FixdXs16VariY';
   def.OutputFcnSpec = ' int16 y1 = LnrIntrpn_s16_u16FixdXs16VariY(uint16 u1,  int16 u2[], uint16 u3, uint16 u4)';
 ...
 */
#define S_FUNCTION_NAME                LnrIntrpn_s16_u16FixdXs16VariY
...
static void mdlInitializeSizes(SimStruct *S)
{
  ...
  if (ssRTWGenIsCodeGen(S) || ssGetSimMode(S)==SS_SIMMODE_EXTERNAL) {
     ...
     */
    ssRegMdlInfo(S, "LnrIntrpn_s16_u16FixdXs16VariY", MDL_INFO_ID_RESERVED, 0, 0,
                 ssGetPath(S));
  }
 ...
 */
*y1 = LnrIntrpn_s16_u16FixdXs16VariY( *u1, u2, *u3, *u4);
}
