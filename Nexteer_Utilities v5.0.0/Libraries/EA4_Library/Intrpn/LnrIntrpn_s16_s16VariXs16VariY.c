/*
 *   LnrIntrpn_s16_s16VariXs16VariY.c Simple C-MEX S-function for function call.
 *
 *   ABSTRACT:
 *     The purpose of this sfunction is to call a simple legacy
 *     function during simulation:
 *
 *         int16 y1 = LnrIntrpn_s16_s16VariXs16VariY( int16 u1[],  int16 u2[], uint16 u3,  int16 u4)
 *
 *   Simulink version           : 8.2 (R2013b) 08-Aug-2013
 *   C source code generated on : 27-Mar-2015 15:12:20
...
/*
   ...
   def.SFunctionName = 'LnrIntrpn_s16_s16VariXs16VariY';
   def.OutputFcnSpec = ' int16 y1 = LnrIntrpn_s16_s16VariXs16VariY( int16 u1[],  int16 u2[], uint16 u3,  int16 u4)';
 ...
 */
#define S_FUNCTION_NAME                LnrIntrpn_s16_s16VariXs16VariY
...
static void mdlInitializeSizes(SimStruct *S)
{
  ...
  if (ssRTWGenIsCodeGen(S) || ssGetSimMode(S)==SS_SIMMODE_EXTERNAL) {
     ...
     */
    ssRegMdlInfo(S, "LnrIntrpn_s16_s16VariXs16VariY", MDL_INFO_ID_RESERVED, 0, 0,
                 ssGetPath(S));
  }
 ...
 */
*y1 = LnrIntrpn_s16_s16VariXs16VariY( u1, u2, *u3, *u4);
}
