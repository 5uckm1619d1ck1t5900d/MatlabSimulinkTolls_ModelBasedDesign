/*
 *   FPM_s16_FixedToFloat_m.c Simple C-MEX S-function for function call.
 *
 *   ABSTRACT:
 *     The purpose of this sfunction is to call a simple legacy
 *     function during simulation:
 *
 *        single y1 = FPM_s16_FixedToFloat_m(int16 u1,  single p1)
 *
 *   Simulink version           : 8.2 (R2013b) 08-Aug-2013
 *   C source code generated on : 11-Jun-2014 10:23:58
...
/*
   ...
   def.SFunctionName = 'FPM_s16_FixedToFloat_m';
   def.OutputFcnSpec = 'single y1 = FPM_s16_FixedToFloat_m(int16 u1,  single p1)';
 ...
 */
#define S_FUNCTION_NAME                FPM_s16_FixedToFloat_m
...
static void mdlInitializeSizes(SimStruct *S)
{
  ...
  if (ssRTWGenIsCodeGen(S) || ssGetSimMode(S)==SS_SIMMODE_EXTERNAL) {
     ...
     */
    ssRegMdlInfo(S, "FPM_s16_FixedToFloat_m", MDL_INFO_ID_RESERVED, 0, 0,
                 ssGetPath(S));
  }
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
   ...
   */
  *y1 = FPM_s16_FixedToFloat_m( *u1, *p1);
}
