/*
 *   Sign_f32_m.c Simple C-MEX S-function for function call.
 *
 *   ABSTRACT:
 *     The purpose of this sfunction is to call a simple legacy
 *     function during simulation:
 *
 *        single y1 = Sign_f32_m(single u1)
 *
 *   Simulink version           : 8.2 (R2013b) 08-Aug-2013
 *   C source code generated on : 21-May-2014 13:23:44
...
/*
   ...
   def.SFunctionName = 'Sign_f32_m';
   def.OutputFcnSpec = 'single y1 = Sign_f32_m(single u1)';
 ...
 */
#define S_FUNCTION_NAME                Sign_f32_m
...
static void mdlInitializeSizes(SimStruct *S)
{
  ...
  if (ssRTWGenIsCodeGen(S) || ssGetSimMode(S)==SS_SIMMODE_EXTERNAL) {
     ...
     */
    ssRegMdlInfo(S, "Sign_f32_m", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));
  }
