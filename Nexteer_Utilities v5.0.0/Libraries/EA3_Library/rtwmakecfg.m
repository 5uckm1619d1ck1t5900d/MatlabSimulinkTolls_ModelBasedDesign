...
%   MATLAB file generated on : 29-May-2014 11:18:48
...
% Dependency info for S-function 'FPM_FloatToFix_m'
info(1).SFunctionName = 'FPM_FloatToFix_m';
info(1).SourceFiles = {'utility.c'};
info(1).Language = 'C';
