/*
 *   IntplVarXY_f32_f32Xf32Y_Cnt.c Simple C-MEX S-function for function call.
 *
 *   ABSTRACT:
 *     The purpose of this sfunction is to call a simple legacy
 *     function during simulation:
 *
 *        single y1 = IntplVarXY_f32_f32Xf32Y_Cnt(single p1[], single p2[], uint16 size(p1,1), single u1)
 *
 *   Simulink version           : 8.2 (R2013b) 08-Aug-2013
 *   C source code generated on : 21-May-2014 13:23:49
...
/*
   ...
   def.SFunctionName = 'IntplVarXY_f32_f32Xf32Y_Cnt';
   def.OutputFcnSpec = 'single y1 = IntplVarXY_f32_f32Xf32Y_Cnt(single p1[], single p2[], uint16 size(p1,1), single u1)';
 ...
 */
#define S_FUNCTION_NAME                IntplVarXY_f32_f32Xf32Y_Cnt
...
static void mdlInitializeSizes(SimStruct *S)
{
  ...
  if (ssRTWGenIsCodeGen(S) || ssGetSimMode(S)==SS_SIMMODE_EXTERNAL) {
     ...
     */
    ssRegMdlInfo(S, "IntplVarXY_f32_f32Xf32Y_Cnt", MDL_INFO_ID_RESERVED, 0, 0,
                 ssGetPath(S));
  }
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
   ...
   */
  *y1 = IntplVarXY_f32_f32Xf32Y_Cnt( p1, p2, p1_dim1, *u1);
}
