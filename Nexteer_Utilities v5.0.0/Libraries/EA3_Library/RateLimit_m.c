/*
 *   RateLimit_m.c Simple C-MEX S-function for function call.
 *
 *   ABSTRACT:
 *     The purpose of this sfunction is to call a simple legacy
 *     function during simulation:
 *
 *        single y1 = RateLimit_m(single u1, single u2, single u3, single u4, single u5)
 *
 *   Simulink version           : 8.2 (R2013b) 08-Aug-2013
 *   C source code generated on : 24-Jun-2014 14:15:01
...
/*
   ...
   def.SFunctionName = 'RateLimit_m';
   def.OutputFcnSpec = 'single y1 = RateLimit_m(single u1, single u2, single u3, single u4, single u5)';
 ...
 */
#define S_FUNCTION_NAME                RateLimit_m
...
static void mdlInitializeSizes(SimStruct *S)
{
  ...
  if (ssRTWGenIsCodeGen(S) || ssGetSimMode(S)==SS_SIMMODE_EXTERNAL) {
     ...
     */
    ssRegMdlInfo(S, "RateLimit_m", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));
  }
