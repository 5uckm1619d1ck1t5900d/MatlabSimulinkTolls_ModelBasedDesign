/*
 *   Limit_m.c Simple C-MEX S-function for function call.
 *
 *   ABSTRACT:
 *     The purpose of this sfunction is to call a simple legacy
 *     function during simulation:
 *
 *        single y1 = Limit_m(single u1, single u2, single u3)
 *
 *   Simulink version           : 8.2 (R2013b) 08-Aug-2013
 *   C source code generated on : 21-May-2014 13:23:38
...
/*
   ...
   def.SFunctionName = 'Limit_m';
   def.OutputFcnSpec = 'single y1 = Limit_m(single u1, single u2, single u3)';
 ...
 */
#define S_FUNCTION_NAME                Limit_m
...
static void mdlInitializeSizes(SimStruct *S)
{
  ...
  if (ssRTWGenIsCodeGen(S) || ssGetSimMode(S)==SS_SIMMODE_EXTERNAL) {
     ...
     */
    ssRegMdlInfo(S, "Limit_m", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));
  }
