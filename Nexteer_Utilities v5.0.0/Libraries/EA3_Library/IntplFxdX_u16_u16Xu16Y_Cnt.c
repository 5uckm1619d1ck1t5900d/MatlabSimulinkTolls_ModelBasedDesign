/*
 *   IntplFxdX_u16_u16Xu16Y_Cnt.c Simple C-MEX S-function for function call.
 *
 *   ABSTRACT:
 *     The purpose of this sfunction is to call a simple legacy
 *     function during simulation:
 *
 *        uint16 y1 = IntplFxdX_u16_u16Xu16Y_Cnt(uint16 p1, uint16 p2[], uint16 size(p2,1), uint16 u1)
 *
 *   Simulink version           : 8.2 (R2013b) 08-Aug-2013
 *   C source code generated on : 21-May-2014 13:24:11
...
/*
   ...
   def.SFunctionName = 'IntplFxdX_u16_u16Xu16Y_Cnt';
   def.OutputFcnSpec = 'uint16 y1 = IntplFxdX_u16_u16Xu16Y_Cnt(uint16 p1, uint16 p2[], uint16 size(p2,1), uint16 u1)';
 ...
 */
#define S_FUNCTION_NAME                IntplFxdX_u16_u16Xu16Y_Cnt
...
static void mdlInitializeSizes(SimStruct *S)
{
  ...
  if (ssRTWGenIsCodeGen(S) || ssGetSimMode(S)==SS_SIMMODE_EXTERNAL) {
     ...
     */
    ssRegMdlInfo(S, "IntplFxdX_u16_u16Xu16Y_Cnt", MDL_INFO_ID_RESERVED, 0, 0,
                 ssGetPath(S));
  }
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
  ...
  uint16_T p2_dim1 = (uint16_T) mxGetNumberOfElements(ssGetSFcnParam(S, 1));
  uint16_T *y1 = (uint16_T *) ssGetOutputPortSignal(S, 0);

  /*
   * Call the legacy code function
   */
  *y1 = IntplFxdX_u16_u16Xu16Y_Cnt( *p1, p2, p2_dim1, *u1);
}
