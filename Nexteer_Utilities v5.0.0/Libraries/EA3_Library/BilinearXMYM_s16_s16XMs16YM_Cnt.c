/*
 *   BilinearXMYM_s16_s16XMs16YM_Cnt.c Simple C-MEX S-function for function call.
 *
 *   ABSTRACT:
 *     The purpose of this sfunction is to call a simple legacy
 *     function during simulation:
 *
 *        int16 y1 = BilinearXMYM_s16_s16XMs16YM_Cnt(uint16 u1,  int16 u2, uint16 p1[], uint16 size(p1,1),  int16 p2[][],  int16 p3[][], uint16 size(p3,1))
 *
 *   Simulink version           : 8.2 (R2013b) 08-Aug-2013
 *   C source code generated on : 21-May-2014 13:24:01
...
/*
   ...
   def.SFunctionName = 'BilinearXMYM_s16_s16XMs16YM_Cnt';
   def.OutputFcnSpec = 'int16 y1 = BilinearXMYM_s16_s16XMs16YM_Cnt(uint16 u1,  int16 u2, uint16 p1[], uint16 size(p1,1),  int16 p2[][],  int16 p3[][], uint16 size(p3,1))';
 ...
 */
#define S_FUNCTION_NAME                BilinearXMYM_s16_s16XMs16YM_Cnt
...
static void mdlInitializeSizes(SimStruct *S)
{
  ...
  if (ssRTWGenIsCodeGen(S) || ssGetSimMode(S)==SS_SIMMODE_EXTERNAL) {
     ...
     */
    ssRegMdlInfo(S, "BilinearXMYM_s16_s16XMs16YM_Cnt", MDL_INFO_ID_RESERVED, 0,
                 0, ssGetPath(S));
  }
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
   ...
   */
  *y1 = BilinearXMYM_s16_s16XMs16YM_Cnt( *u1, *u2, p1, p1_dim1, p2, p3, p3_dim1);
}
